...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/shrill-frog-b1ef)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-frog-b1ef
```

A live public deployment of this template is available at [https://shrill-frog-b1ef.templates.workers.dev](https://shrill-frog-b1ef.templates.workers.dev)
